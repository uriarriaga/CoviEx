...
def sendWidgetSMS(contacto,token):
    ...
    #texto = "Servicio de TeleConsulta INER. Para iniciar la videollamada favor de ingresar a la siguiente direccion: https://bdcc448e.ngrok.io/widget?token=" + token 
    sendSMS("+52"+contacto,texto)
"""
